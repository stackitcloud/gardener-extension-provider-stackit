...
// Source: github.com/stackitcloud/gardener-extension-provider-stackit/v2/pkg/openstack/client (interfaces: Factory,FactoryFactory,Compute,DNS,Networking,Loadbalancing)
//
// Generated by this command:
//
//	mockgen -destination=mocks/client_mocks.go -package=mocks . Factory,FactoryFactory,Compute,DNS,Networking,Loadbalancing
//
...
func (m *MockNetworking) AddTag(ctx context.Context, resourceType, resourceID, tag string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddTag", ctx, resourceType, resourceID, tag)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockNetworkingMockRecorder) AddTag(ctx, resourceType, resourceID, tag any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddTag", reflect.TypeOf((*MockNetworking)(nil).AddTag), ctx, resourceType, resourceID, tag)
}
...
func (m *MockNetworking) GetRouterInterfacePortsByNetwork(ctx context.Context, networkID string) ([]ports.Port, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRouterInterfacePortsByNetwork", ctx, networkID)
	ret0, _ := ret[0].([]ports.Port)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockNetworkingMockRecorder) GetRouterInterfacePortsByNetwork(ctx, networkID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRouterInterfacePortsByNetwork", reflect.TypeOf((*MockNetworking)(nil).GetRouterInterfacePortsByNetwork), ctx, networkID)
}
...
func (m *MockNetworking) UpdateSubnet(ctx context.Context, subnetID string, updateOpts subnets.UpdateOpts) (*subnets.Subnet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateSubnet", ctx, subnetID, updateOpts)
	ret0, _ := ret[0].(*subnets.Subnet)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockNetworkingMockRecorder) UpdateSubnet(ctx, subnetID, updateOpts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateSubnet", reflect.TypeOf((*MockNetworking)(nil).UpdateSubnet), ctx, subnetID, updateOpts)
}
...
func (mr *MockLoadbalancingMockRecorder) ListLoadbalancers(ctx, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLoadbalancers", reflect.TypeOf((*MockLoadbalancing)(nil).ListLoadbalancers), ctx, opts)
}
