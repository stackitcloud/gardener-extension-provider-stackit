...
const (
	...
	// STACKITApplicationLoadBalancerControllerName is a constant for the name of the ALB CloudController. (stackit)
	STACKITApplicationLoadBalancerControllerName = "stackit-application-load-balancer-controller"
